<?php
    ...
    if (isset($_POST['register'])){
        ...
        $qry = "INSERT INTO `login` (`id`, `email`, `password`) VALUES (NULL, '$email', '$password')";
...
<body style="background-image: url(home.jpg);">
    <div class="sign-up-form">
        ...
        <h1>Register Now Now</h1>
        <form action="" onsubmit="return btnClick()" method="POST">
            <input type="text" id="email" placeholder="Enter Email" class="input-box" name="email">
            <label for="email" id="emailEmptyLbl" style="color: red; visibility: hidden;">Please Enter Email</label>
            <input type="text" id="password" placeholder="Enter Password" class="input-box" name="password">
            ...
            <a href="index.php"><button class="btn btn-outline-primary" name="register">Register</button></a>
            <p class="register-link">Do you have an account? <a href="#">Login</a></p>
        </form>
    </div>
</body>
</html>